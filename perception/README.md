...
Datasets: Each captured sample is stored as image + semantic mask + geometry metadata

## Core variables (per frame k) include: 
...
e.g., floor=1 (Green) - Flyable Space, obstacle=2 (Light Blue & Pink)

![Environment](camera/env_setup.png)
