    ...
    conversation = [
        ...
        },
        {
            ...
            "content": [
                {
                    "type": "video",
                    "video": f"{ROOT}/assets/drone_test.mp4" },
#                   {"type": "video",
#                    "video": f"{ROOT}/assets/down_cam.mp4"},                    
                
                {
                    "type": "text",
                    "text": (
#                        "The first video is a side-facing camera. "
                        "The video is a front-facing camera of flying Quadrotor moving towards NVIDIA building. "
                        "Infer as the obstacle approaches and plan how to avoid it." 
                    ),
                },
